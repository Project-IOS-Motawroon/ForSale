...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FTNotificationIndicator/FTNotificationIndicator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FTToastIndicator/FTToastIndicator.framework"
